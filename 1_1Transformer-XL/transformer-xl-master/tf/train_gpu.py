...
flags.DEFINE_integer("num_hosts", default=1,
                     help="Number of TPU hosts 主机数")
flags.DEFINE_integer("num_core_per_host", default=8,
                     help="Number of cores per host GPU的核数")
...
flags.DEFINE_string("model_dir", default=None,
                    help="Estimator model_dir.模型保存地址")
...
flags.DEFINE_integer("train_batch_size", default=60,
                     help="Size of train batch.每个batch_size大小")
flags.DEFINE_integer("eval_batch_size", default=60,
                     help="Size of valid batch.")
flags.DEFINE_integer("train_steps", default=100,
                     help="Total number of training steps.就是跑多少个epoch")
flags.DEFINE_integer("iterations", default=500,
                     help="Number of iterations per repeat loop.每次迭代跑500个batch_size")
