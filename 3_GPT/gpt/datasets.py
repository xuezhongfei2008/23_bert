...
def rocstories(data_dir, n_train=1497, n_valid=1):
    storys, comps1, comps2, ys = _rocstories(os.path.join(data_dir, 'aa.csv'))
    teX1, teX2, teX3, _ = _rocstories(os.path.join(data_dir, 'aa.csv'))
