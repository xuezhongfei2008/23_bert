...
ff=open('./data/vocab_seg_words_elmo.txt',mode='r',encoding='utf-8')
raw_context=[]
with open('./data/vocab_seg_words_elmo.txt', 'r') as f:
    for line in f.readlines():
        raw_context.append(line.strip()) # 把末尾的'\n'删掉
# Our small dataset.
raw_context = [
    '捡起来 。',
    '徒儿 。'
]
# raw_context=raw_context[0:128]
...
token_embedding_file='./log/vocab_weights.hdf5'
...
# print("question_token_ids",question_token_ids)
